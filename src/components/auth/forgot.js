                ...
                <div className="auth__form">
                   ...
                   :  <>
                    <div className="auth__form-header">
                        ...
                        <span className="auth__form-subtitle_forgot auth__form-subtitle mb-4">The message has been sent to your address <b>{this.state.email ? this.state.email.replace(/(\w{3})[\w.-]+@([\w.]+\w)/, "$1***@$2") : ''}</b>. Follow the instructions in the message to reset your password.</span>
